...
p <- ggplot() +
  ...
  # Unfortunately we couldn't quite figure out how to inlude the legend for this layered plot. The blue dots and blue smoothed regression present the conservative fertility data, the red dots and line present the mainline fertility data, and the black line presents the average fertility data.  
p
